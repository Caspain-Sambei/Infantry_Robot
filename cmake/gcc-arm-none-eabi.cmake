...
set(CMAKE_C_FLAGS_DEBUG "-O0 -g3 -gdwarf-4")  # ← 加上-gdwarf-4
set(CMAKE_CXX_FLAGS_DEBUG "-O0 -g3")
set(CMAKE_CXX_FLAGS_RELEASE "-Os -g0")
set(CMAKE_CXX_FLAGS_DEBUG "-O0 -g3 -gdwarf-4")  # ← 加上-gdwarf-4
...
# === 关键修复：修正链接器标志。在set(TOOLCHAIN_LINK_LIBRARIES "m")上面添加
# 清空并重新设置链接器标志
set(CMAKE_EXE_LINKER_FLAGS "")##

# 添加必要的链接标志
set(CMAKE_EXE_LINKER_FLAGS "${CMAKE_EXE_LINKER_FLAGS} -mcpu=cortex-m4 -mthumb -mfloat-abi=hard -mfpu=fpv4-sp-d16")##
